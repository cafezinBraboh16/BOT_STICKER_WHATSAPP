...
const start = (pakforlay = new Client()) => {
    ...
    console.log(color(figlet.textSync('VOCÊ SE FUDEU!', { font: 'Ghost', horizontalLayout: 'default' })))
    console.log(color(figlet.textSync('----------------', { horizontalLayout: 'default' })))
    console.log(color('[DEV]'), color('pakforlay', 'yellow'))
    console.log(color('[~>>]'), color('NGM MANDOU BAIXA, AGR TA COM VIRUS OTARIO!', 'green'))
